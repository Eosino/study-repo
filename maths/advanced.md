...
| $f(x,y)$ 在 $(0,0)$ 可微的两个冲要条件 |  <br> $\lim\limits_{(x,y)\to(0,0)}\frac{f(x,y)-f(0,0)}{x^2+y^2} \space \exists \implies \lim\limits_{(x,y)\to(0,0)}\frac{f(x,y)-f(0,0)}{\sqrt{x^2+y^2}}=0 \implies$ 可微 |
|  |  |
