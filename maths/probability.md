...
## 6.2. 三大抽样分布
1. $\chi^2$ 分布
   1. 独立同分布的 $X_i\sim N(0,1)$，则 $\sum_{i=1}^nX_i^2$ 服从自由度为 $n$ 的 $\chi^2$ 分布，记为 $\chi^2\sim\chi^2(n)$
      1. $E(\chi^2)=n$
      2. $D(\chi^2)=2n$
...
2. $t$ 分布
   ...
   3. $E(T)=0$
3. $F$ 分布
   1. 设 $X\sim\chi^2(n_1),Y\sim\chi^2(n_2)$，$X,Y$ 独立，则 $F=\frac{X/n_1}{Y/n_2}\sim F(n_1,n_2)$
